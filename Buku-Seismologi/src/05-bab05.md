...
Table: **Tabel 5.1.** Contoh himpunan data untuk penyelesaian bidang sesar: jarak episenter $\Delta$, azimut stasiun $A_{ES}$, polaritas gerakan pertama P (C = kompresi, D = dilatasi), dan sudut tinggal landas $i_h$. Data diambil dari bahan ajar asli Waluyo.

| Sta | $\Delta$ (°) | $A_{ES}$ (°) | Pol | $i_h$ (°) | Sta | $\Delta$ (°) | $A_{ES}$ (°) | Pol | $i_h$ (°) |
|:--|--:|--:|:-:|--:|:--|--:|--:|:-:|--:|
...
::: {custom-style="ImageCaption"}
**Gambar 5.14.** Diagram bola fokus beberapa gempa penting di Indonesia,
memperlihatkan tiga rezim tektonik yang berbeda: sesar naik pada zona
subduksi, sesar geser pada sesar kerak, dan sesar naik pada belakang busur.
:::
